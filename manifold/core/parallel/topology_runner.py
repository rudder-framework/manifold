...
def _process_entity(entity_id: str, obs: pl.DataFrame, params: Dict[str, Any]) -> List[Dict]:
    ...
    from manifold.primitives.embedding import time_delay_embedding, optimal_delay, optimal_dimension
    from manifold.primitives.topology import persistence_diagram, betti_numbers, persistence_entropy
